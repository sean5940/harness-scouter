...
```
  ...
  2026-07-02 ~ 2026-08-04 · 세션 349개 · 이력 창 29개 · 커버리지 83%
  ────────────────────────────────────────────────────────────────────────────────
  탐색력        █████████████░░░░░░░░░░░  53  C   통상   46~59  최고  67
      파일 찾기 규율        21   n= 1548
      내용 인덱스 우선      46   n= 5114
      근거 확보율           92   n= 1684
  검증력        ███████████████████░░░░░  81  A   통상   74~89  최고  99
      커밋 전 검증 신선도   84   n=  397
      검증 공회전 없음      79   n= 2016
  완수력        █████████████████████░░░  88  A   통상   87~93  최고  98
      산출물 도달           94   n=  170  (표시)
      재작업 없음           88   n= 6123
  자율성        ██████████████████████░░  90  S   통상   85~96  최고 100
      사람 개입 없음        90   n=73629
  규율          ████████████████░░░░░░░░  66  B   통상   70~79  최고  93
      계측 채널 준수        61   n= 9985
      게이트 재발 없음      70   n= 2015
  컨텍스트 효율 ████████████████░░░░░░░░  68  B   통상   64~72  최고  83
      읽기 범위 규율        58   n= 2473
      읽은 것 기억하기      92   n=12964
      응답 간결성           54   n=22949
      컨텍스트 경량성       65   n=47204
  ────────────────────────────────────────────────────────────────────────────────
  종합 71.2 · B  (가장 가까운 등급 컷까지 6.8p)
...
| `tool_call`     | 도구 호출. 이름·명령·파일 경로·차단 여부·에이전트 | 60,584    |
...
**이 저장소는 private 입니다.** 익명 `curl` 로는 받을 수 없고 `gh` 로 인증해서 받습니다.
